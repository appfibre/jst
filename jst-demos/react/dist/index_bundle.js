...
react_dom__WEBPACK_IMPORTED_MODULE_0___default.a.render(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(__webpack_require__(23).default), document.getElementById('window'));
...
module.exports = { "__esModule": true, "__cache": [], "__jst": true, default: class _default extends __webpack_require__(5).Component {
		render() {
			var _parent2 = __webpack_require__(5).createElement("div", { key: 1 }, "outer 123");

			var _parent3 = __webpack_require__(5).createElement(__webpack_require__(24).default || __webpack_require__(24), { key: 2, style: { background: "yellow" }, onClick: () => (module.exports.__cache[1] = module.exports.__cache[1] || new (__webpack_require__(25).default || __webpack_require__(25))(_parent3)).clickevent() }, JSON.stringify("ABC"));

			var _parent4 = __webpack_require__(5).createElement(__webpack_require__(24).default || __webpack_require__(24), { key: 3, style: { background: "blue" }, onClick: () => (module.exports.__cache[2] = module.exports.__cache[2] || new (__webpack_require__(25).default || __webpack_require__(25))(_parent4)).clickevent() }, JSON.stringify("ABC"));

			var _parent5 = __webpack_require__(5).createElement(__webpack_require__(26).A, { key: 4 }, ["div", null, "test button"]);

			var _parent6 = __webpack_require__(5).createElement(__webpack_require__(26).B, { key: 5 }, "GHI");

			var _parent7 = __webpack_require__(5).createElement(__webpack_require__(27).default || __webpack_require__(27), { key: 6, bgcolor: "green" }, ["layout"]);

			var _parent9 = __webpack_require__(5).createElement("div", { key: 1 }, "line 1");

			var _parent10 = __webpack_require__(5).createElement("div", { key: 2 }, "line 2");

			var _parent8 = __webpack_require__(5).createElement("div", { key: 7, style: { "background": "red" } }, [_parent9, _parent10]);

			var _parent = __webpack_require__(5).createElement("div", { key: 0, style: { border: "1px solid orange" } }, [_parent2, _parent3, _parent4, _parent5, _parent6, _parent7, _parent8]);
...
class A extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
	render() {
		return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
			"button",
			_extends({}, this.props, { onClick: () => {
					debugger;alert(JSON.stringify(this.props));
				} }),
			this.props.children
		);
	}
...
class B extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
	render() {
		return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
			"div",
			this.props,
...
module.exports = { "__esModule": true, "__cache": [], "__jst": true, default: class _default extends __webpack_require__(5).Component {
    render() {
      var _parent = __webpack_require__(5).createElement("div", { key: 8, style: { background: this.props.bgcolor }, onClick: () => {
          debugger;alert(JSON.stringify(_parent.props));alert(JSON.stringify(this.props));
        } }, this.props.children);
